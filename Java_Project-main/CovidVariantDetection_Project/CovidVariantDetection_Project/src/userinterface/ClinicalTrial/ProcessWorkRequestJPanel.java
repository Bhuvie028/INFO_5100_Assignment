...
//        for (Variant v1 : ((LabTestWorkRequest) request).getPatient().getVariantHistory().getVariantHistory()) {
//            sampleCheck.add(v1.getGeneName());
//        }
    ...
    private void addSampleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSampleBtnActionPerformed
        ...
        //            sampleCheck.add(g1.getGeneName().toLowerCase());
        //
        //        }
        //        if (sampleCheck.contains(geneName.toLowerCase())) {
