...
//    private static final String filePath = "./prescription data.txt";
    ...
    private void initComponents() {
        ...
        add(doctorPrescriptionLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 683, -1));

        nameLbl.setText("NAME:");
        add(nameLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, -1, -1));
        add(nameTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, 132, -1));

        ageLbl.setText("AGE:");
        add(ageLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, -1, -1));
        add(ageTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 230, 132, -1));
        ...
        add(dateLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, -1, 26));
        ...
        add(DateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, -1, -1));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 20, 90, -1));
    ...
    private void savePrescriptionBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePrescriptionBtnActionPerformed
        ...
        if (flag == true) {
            ...
            populateWorkRequestTable();
//            saveRecord(p.getNetworkName(), p.getIssue(), p.getMedName());
